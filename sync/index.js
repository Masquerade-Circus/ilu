...
function getRuntimeOptions(consumerAdapter = adapter, overrides = {}) {
  ...
  return {
    ...
    buildCommitMessage: typeof overrides.buildCommitMessage === 'function'
      ...
      : context => consumerAdapter.buildCommitMessage(context)
  };
}
...
function createBootstrapBackend(options = {}) {
...
function initializeSyncState(state = {}) {
...
function createSyncRuntimeAdvanced(options = {}) {
  runtime = createEngineRuntimeAdvanced({
    ...
    buildCommitMessage: typeof options.buildCommitMessage === 'function'
      ...
      : context => adapter.buildCommitMessage(context),
