...
export function initialFocusForNotesOverlay(state: NotesRuntimeState): string | null {
  if (state.overlay === "add-note") return "note-add-title";
  if (state.overlay === "edit-note") return "note-edit-title";
  if (state.overlay === "note-details") return "note-details-scroll";
  if (state.overlay === "remove-note-confirm") return "note-remove-confirm";
  if (state.overlay === "manage-lists") return "note-lists";
  if (state.overlay === "add-list") return "note-add-list-title";
  if (state.overlay === "rename-list") return "note-rename-list-title";
  if (state.overlay === "remove-list-confirm") return "note-remove-list-confirm";
