...
export function initialFocusForTodoOverlay(state: TodoRuntimeState): string | null {
  if (state.overlay === "add-task") return "todo-add-title";
  if (state.overlay === "edit-task") return "todo-edit-title";
  if (state.overlay === "task-details") return "todo-details-scroll";
  if (state.overlay === "remove-task-confirm") return "todo-remove-confirm";
  if (state.overlay === "manage-lists") return "todo-lists";
  if (state.overlay === "add-list") return "todo-add-list-title";
  if (state.overlay === "rename-list") return "todo-rename-list-title";
  if (state.overlay === "remove-list-confirm") return "todo-remove-list-confirm";
