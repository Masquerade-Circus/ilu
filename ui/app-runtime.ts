...
export type TuiSyncRunnerClient = { sync: (context?: unknown) => Promise<unknown>; reconcileFile?: (input: unknown) => Promise<unknown>; flush?: () => Promise<unknown>; shutdown?: () => Promise<unknown>; dispose?: () => void; hasPendingWork?: () => boolean; onEvent?: (listener: (event: SyncStatusEvent) => void) => () => void };
