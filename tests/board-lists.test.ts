...
const boardListsModulePath = path.join(repoRoot, 'scrumban', 'board-lists.ts');
...
function loadBoardListsWithStubs({promptAnswers = [], savedBoards = [], events}: any = {}) {
